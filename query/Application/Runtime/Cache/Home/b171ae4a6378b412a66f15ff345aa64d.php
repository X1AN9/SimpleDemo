	...
	<body>
		...
		<div class="container" style="border-top:1px solid #e0e0e0">
			...
			<footer class="cart-bar">
				<a class="cart" href='<?php echo U('Index/car');?>'>
				...
				<div class="result">
					...
					<a href="<?php echo U('Index/update');?>?id=<?php echo ($sp["shop_id"]); ?>" class="open-popup" data-target="#full" data-button="data-button-gm">
						<button class="" style="background:#E02E24;width:35%">
							纠正商品
						</button>
					</a>
					<a href='<?php echo U('Index/addcar');?>?id=<?php echo ($sp["shop_id"]); ?>&gonghuoshang=<?php echo ($sp["shop_gonghuoshang"]); ?>'>
