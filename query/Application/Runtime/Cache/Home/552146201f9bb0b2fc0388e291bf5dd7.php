	...
	<body>
		<div class="container mt">
			...
			<div id="search" style="margin-top:35px">
				<form action="<?php echo U('Mark/search');?>" method="post">
					...
					<table class="tb" id='tab' align="center">
						<?php if(is_array($sp)): foreach($sp as $key=>$sp): ?><tr style="margin-top:5px;">
								<td style="text-align:left;position:relative;width:100%" onclick="location.href='<?php echo U('Mark/searchById');?>?shop_id=<?php echo ($sp["shop_id"]); ?>'">
									<a href="<?php echo U('Mark/searchById');?>?shop_id=<?php echo ($sp["shop_id"]); ?>" style="display:block;padding:5px 0">
		...
		<div class="fixed">
			<div class="">
				<a href='<?php echo U('Mark/car');?>'>
					<img src="/query/Public/img/shop.png" alt="">
					<p>订单管理</p>
				</a>
			</div>
			<div class="">
				<a href='<?php echo U('Mark/addgonghuoshang');?>'>
					<img src="/query/Public/img/shop1.png" alt="">
					<p>新增供应商</p>
				</a>
			</div>
			<div class="img">
				<a href='<?php echo U('Mark/add');?>'>
					<img src="/query/Public/img/pic.png" alt="">
					<p>新增商品</p>
				</a>
			</div>
			<div class="img">
				<a href='<?php echo U('Mark/fenlei');?>'>
		...
		<div class="mod_aside_v2 main">
			...
			<div class="mod_aside_v2_nav">
				...
				<div id="sideNavItems">
					<a href='<?php echo U('Mark/car');?>' class="mod_aside_v2_nav_item">
						<img src="/query/Public/img/2.png" alt="">
						<span>订单管理</span>
					</a>
					<a href='<?php echo U('Mark/addgonghuoshang');?>' class="mod_aside_v2_nav_item">
						<img src="/query/Public/img/1.png" alt="">
						<span>新增供应商</span>
					</a>
					<a href='<?php echo U('Mark/add');?>' class="mod_aside_v2_nav_item img">
						<img src="/query/Public/img/3.png" alt="">
						<span>新增商品</span>
					</a>
					<a href='<?php echo U('Mark/fenlei');?>' class="mod_aside_v2_nav_item img">
