...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="button">
            ...
            <span type="button" class="share1"  onclick="app1()" ><img src="/query/Public/img/share.png" alt="" width="20"> 分享</span>
            <span type="button" class="share"  onclick="app()"><img src="/query/Public/img/share.png" alt="" width="20"> 分享</span>
            <div id="sss" >
              <div style="position: absolute;top: 1px;right: 5px;" onclick="modeclose()"><img src="/query/Public/img/cuo.png" alt="" width="25"></div>
              <span style="float:left">
                <div class="bdsharebuttonbox">
					<a href="#" class="popup_sqq" data-cmd="sqq"></a>
                	<span  style="padding-right: 6px;">QQ</span
				</div>
              </span>
              &nbsp;&nbsp;&nbsp;&nbsp;
              <span style="float:right">
				<div class="bdsharebuttonbox">
                	...
                	<span  style="padding-right: 6px;">微信</span
				</div>
              </span>
            </div>
          </div>
          ...
          <div id="text">
            <div class="div">
              <div style="position: absolute;top: 10px;right: 10px;" onclick="modeclose()"><img src="/query/Public/img/cuo.png" alt="" width="30"></div>
              <span>
                <img src="/query/Public/img/qq(1).png" alt="" width="50">
                <span>QQ</span>
              </span>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <span>
                <img src="/query/Public/img/wx.png" alt="" width="50">
                <span>微信</span>
              </span>
            </div>
          </div>
