...
! function(e) {
	...
	var n = document,
		...
		l = {
			layer: "__PUBLIC__/lay/modules/layer",
			laydate: "__PUBLIC__/lay/modules/laydate",
			laypage: "__PUBLIC__/lay/modules/laypage",
			laytpl: "__PUBLIC__/lay/modules/laytpl",
			layim: "__PUBLIC__/lay/modules/layim",
			layedit: "__PUBLIC__/lay/modules/layedit",
			form: "__PUBLIC__/lay/modules/form",
			upload: "__PUBLIC__/lay/modules/upload",
			tree: "__PUBLIC__/lay/modules/tree",
			slide: "__PUBLIC__/lay/modules/slide",
			table: "__PUBLIC__/lay/modules/table",
			element: "__PUBLIC__/lay/modules/element",
			util: "__PUBLIC__/lay/modules/util",
			flow: "__PUBLIC__/lay/modules/flow",
			code: "__PUBLIC__/lay/modules/code",
			single: "__PUBLIC__/lay/modules/single",
			mobile: "__PUBLIC__/lay/modules/mobile",
			jquery: "__PUBLIC__/lay/modules/jquery",
			"layui.mod": "__PUBLIC__/lay/dest/layui.mod"
		};
